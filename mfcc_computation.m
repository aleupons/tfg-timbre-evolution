...
%mfcc_computation(groupNum)

%This function computes the first 14 MFCC coefficients (from 0th to 13th)
%and their delta-MFCC and delta-delta-MFCC for 50ms frames with half 
...
%every MFCC coefficient in order to make the bag of frames. For delta and
%delta-delta only their mean and variance are computed

%groupNum: matrix number corresponding to data-set group (1,2,3,4 or 5)

%MFCCX.mat saves MFCCs and MFCCs and deltas bag of frames for the selected
%group
