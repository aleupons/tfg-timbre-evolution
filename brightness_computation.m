...
%brightness_computation(groupNum)

%This function computes brightness (amount of spectral energy corresponding
%to frequencies higher than a given cut-off threshold: 1500Hz) for 50ms 
%frames with half overlapping of every song of the selected group of the 
%data-set. Then, mean, variance, minimum, maximum and median statistics are 
%computed for brightness values of each song in order to make the bag of 
%frames

%groupNum: matrix number corresponding to data-set group (1,2,3,4 or 5)

%BX.mat saves brightness values and its bag of frames for the selected 
%group
