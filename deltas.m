...
%This function calculates the deltas (derivatives) of a sequence. Use a 
%W-point window (W odd, default 9) to calculate deltas using a simple 
%linear slope. This mirrors the delta calculation performed in feacalc etc. 
%Each row of X is filtered separately.

%Author: Dan Ellis, PLP and RASTA, Columbia
%Date: 30 June 2003
