...
load('C:\Users\usuario\Documents\TFG\MFCC\TrainData1.mat');
load('C:\Users\usuario\Documents\TFG\MFCC\B1.mat');
load('C:\Users\usuario\Documents\TFG\MFCC\ZC1.mat');
TD1 = TrainData;
D1 = D;
y1 = years;
B1 = BdataS;
...
load('C:\Users\usuario\Documents\TFG\MFCC\TrainData2.mat');
load('C:\Users\usuario\Documents\TFG\MFCC\B2.mat');
load('C:\Users\usuario\Documents\TFG\MFCC\ZC2.mat');
TD2 = TrainData;
D2 = D;
y2 = years;
B2 = BdataS;
...
load('C:\Users\usuario\Documents\TFG\MFCC\TrainData3.mat');
load('C:\Users\usuario\Documents\TFG\MFCC\B3.mat');
load('C:\Users\usuario\Documents\TFG\MFCC\ZC3.mat');
TD3 = TrainData;
D3 = D;
y3 = years;
B3 = BdataS;
...
load('C:\Users\usuario\Documents\TFG\MFCC\TrainData4.mat');
load('C:\Users\usuario\Documents\TFG\MFCC\B4.mat');
load('C:\Users\usuario\Documents\TFG\MFCC\ZC4.mat');
TD4 = TrainData;
D4 = D;
y4 = years;
B4 = BdataS;
...
load('C:\Users\usuario\Documents\TFG\MFCC\TrainData5.mat');
load('C:\Users\usuario\Documents\TFG\MFCC\B5.mat');
load('C:\Users\usuario\Documents\TFG\MFCC\ZC5.mat');
TD5 = TrainData;
D5 = D;
y5 = years;
B5 = BdataS;
...
if strcmp(param,'choruses')
    ...
    [cnt,WY,P,CY,NSY,w]=evolution([D1(:,size(D1,2))',D2(:,size(D2,2))',D3(:,size(D3,2))',D4(:,size(D4,2))',D5(:,size(D5,2))'],choruses,[y1,y2,y3,y4,y5],param);
    save a.mat WY P CY NSY w cnt
...
elseif strcmp(param,'keyboard')
    ...
    [cnt,WY,P,CY,NSY,w]=evolution([D1(:,size(D1,2))',D2(:,size(D2,2))',D3(:,size(D3,2))',D4(:,size(D4,2))',D5(:,size(D5,2))'],keyboard,[y1,y2,y3,y4,y5],param);
    save a.mat WY P CY NSY w cnt
...
elseif strcmp(param,'orchestral')
    ...
    [cnt,WY,P,CY,NSY,w]=evolution([D1(:,size(D1,2))',D2(:,size(D2,2))',D3(:,size(D3,2))',D4(:,size(D4,2))',D5(:,size(D5,2))'],orchestral,[y1,y2,y3,y4,y5],param);
    save a.mat WY P CY NSY w cnt
...
elseif strcmp(param,'distorted')
    ...
    [cnt,WY,P,CY,NSY,w]=evolution([D1(:,size(D1,2))',D2(:,size(D2,2))',D3(:,size(D3,2))',D4(:,size(D4,2))',D5(:,size(D5,2))'],distorted,[y1,y2,y3,y4,y5],param);
    save a.mat WY P CY NSY w cnt
...
elseif strcmp(param,'drummach')
    ...
    [cnt,WY,P,CY,NSY,w]=evolution([D1(:,size(D1,2))',D2(:,size(D2,2))',D3(:,size(D3,2))',D4(:,size(D4,2))',D5(:,size(D5,2))'],drummach,[y1,y2,y3,y4,y5],param);
    save a.mat WY P CY NSY w cnt
...
elseif strcmp(param,'lowfreq')
   ...
   data1 = [TD1(:,1:14),TD1(:,29:42),TD1(:,57:84),TD1(:,113:126)];
    ...
    [cnt,WY,P,CY,NSY,w]=evolution([D1(:,size(D1,2))',D2(:,size(D2,2))',D3(:,size(D3,2))',D4(:,size(D4,2))',D5(:,size(D5,2))'],lowfreq,[y1,y2,y3,y4,y5],param);
    save a.mat WY P CY NSY w cnt
...
elseif strcmp(param,'electronic')
    ...
    [cnt,WY,P,CY,NSY,w]=evolution([D1(:,size(D1,2))',D2(:,size(D2,2))',D3(:,size(D3,2))',D4(:,size(D4,2))',D5(:,size(D5,2))'],electronic,[y1,y2,y3,y4,y5],param);
    save a.mat WY P CY NSY w cnt
...
elseif strcmp(param,'choruses90')
    ...
    [cnt,WY,P,CY,NSY,w]=evolution([D1(:,size(D1,2))',D2(:,size(D2,2))',D3(:,size(D3,2))',D4(:,size(D4,2))',D5(:,size(D5,2))'],choruses90,[y1,y2,y3,y4,y5],param);
    save a.mat WY P CY NSY w cnt
...
elseif strcmp(param,'kickdrum')
    ...
    [cnt,WY,P,CY,NSY,w]=evolution([D1(:,size(D1,2))',D2(:,size(D2,2))',D3(:,size(D3,2))',D4(:,size(D4,2))',D5(:,size(D5,2))'],kickdrum,[y1,y2,y3,y4,y5],param);
    save a.mat WY P CY NSY w cnt
...
elseif strcmp(param,'hihats')
    ...
    [cnt,WY,P,CY,NSY,w]=evolution([D1(:,size(D1,2))',D2(:,size(D2,2))',D3(:,size(D3,2))',D4(:,size(D4,2))',D5(:,size(D5,2))'],hihats,[y1,y2,y3,y4,y5],param);
    save a.mat WY P CY NSY w cnt
...
%graphic function
function [cnt,weeksYear,ponderation,charYear,numSongsY,w]=evolution(weeks,music_char,years,param)
